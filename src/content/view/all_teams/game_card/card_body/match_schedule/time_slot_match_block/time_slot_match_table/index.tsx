...
import { useMatchSheet } from '../../../../../../../../content/sheet/match_sheet/match_sheet_provider';
...
export function TimeSlotMatchTable({ teams, game, matchups, slotTime }: Props) {
        ...
        <tbody>
          {matchups.map((fixture) => (
            <tr key={`${fixture.field}-${fixture.home}-${fixture.away}`}>
              <td className="px-3 py-2.5 text-xs font-semibold text-slate-500 align-middle">
              ...
              <td className="px-3 py-2 align-middle">
                <MatchupStrip
                  ...
                  home={fixture.home}
                  away={fixture.away}
                  onOpen={() => openMatchSheet({ game, slotTime, fixture })}
                />
              </td>
            </tr>
          ))}
